...
#        log_dir = 'C://Users//kevin//Documents//tensorflow//VGG//logsvgg//train//'
        train_dir = 'E:/iqa/cnnpy/DTAT/'
        matfn = 'E:/iqa/cnnpy/score/newDT.mat'
        log_dir = 'E:/iqa/cnnpy/171229'
        test, test_score = re16.get_files(train_dir, matfn,'newDT')
        test_batch, test_score_batch = re16.get_batch(test,
                                                          test_score,
                                                          128,
                                                          128,
                                                          32,
...
#                    total_correct += np.sum(batch_correct)
                    out,out2=sess.run([logits,scores])
#                    print(out)
                    output.append(out)
                    output2.append(out2)
                    step += 1
...
#                print('Average accuracy: %.2f%%' %(100*total_correct/num_sample))
        ...
        sio.savemat('output30.mat',{'data':output,'score':output2})
    return output
